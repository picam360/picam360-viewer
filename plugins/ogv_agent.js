var create_plugin = (function() {
	...
	function init() {
		var foward_button = document.createElement("img");
		foward_button.src = "https://free-designer.net/design_img/0319091006.jpg";
		foward_button.width = 100;
		foward_button.height = 100;
		foward_button.attachEvent('onclick', function() {
			console.log("click");
		});

		var container = document.getElementById("container");
		container.add(foward_button);
	}
