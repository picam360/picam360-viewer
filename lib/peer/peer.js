...
Negotiator.startConnection = function(connection, options) {
  ...
  if (options.originator) {
    if (connection.type === 'data') {
      ...
      // Chrome.
      if (util.supports.sctp && connection.reliable === false) {
...
Negotiator._setupListeners = function(connection, pc, pc_id) {
  ...
  pc.onicecandidate = function(evt) {
    if (evt.candidate) {
      util.log('Received ICE candidates:', evt);
...
Negotiator.handleCandidate = function(connection, ice) {
  ...
  util.log('Added ICE candidate:', ice);
}
...
var defaultConfig = {'iceServers': [
                                    ...
                                    {"urls": "turn:picam360@turn.picam360.com:3478", "credential": "picam360"},
                                ]};
var dataCount = 1;
