			...
			for (var i = 0; i < width / 2; i+=BLOCK_SIZE) {
				for (var j = 0; j < width / 2; j+=BLOCK_SIZE) {
					...
					if(is_boundary(position_ary, [v1,v2,v3,v4])){
						...
						for (var _i = 0; _i < BLOCK_SIZE; _i++) {
							for (var _j = 0; _j < BLOCK_SIZE; _j++) {
								var v1 = vertices[_i + _offset_idx][_j + 1];
								var v2 = vertices[_i + _offset_idx][_j];
								var v3 = vertices[_i + 1 + _offset_idx][_j];
								var v4 = vertices[_i + 1 + _offset_idx][_j + 1];
								indices.push(v1, v2, v3);
								indices.push(v3, v4, v1);
								//indices.push(v1, v2, v4);
								//indices.push(v2, v3, v4);
