...
OMVR = (function() {
	...
	function OMVR() {
		...
		var self = {
			...
			setTextureRawYuv : function(vertex_type, data, width, height, quat, fov, uuid, timestamp) {
				...
				m_texture_captured_time_ms = timestamp;
				m_texture_updated_time_ms = new Date().getTime();
			},
			
			setTextureRawRgb : function(vertex_type, img, quat, fov, uuid, timestamp) {
			...
			setTextureImage : function(vertex_type, img, quat, fov, uuid, timestamp) {
				m_updated_image = {
						vertex_type,
						img,
						quat,
			...
			setFrameInfo: function(vertex_type, quat, fov, uuid, timestamp) {
