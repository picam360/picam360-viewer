	...
	function OMVR() {
		...
		var self = {
			...
			init : function(options) {
				...
				m_skip_frame = options.skip_frame;
			...
			load_pglcore : function(callback){				
				...
				script.onload = function() {
					var Module = {
						...
						onRuntimeInitialized : function() {
							...
							m_modules['picam360-glcore']._pglcore_init(window.innerWidth, window.innerHeight);
							m_modules['picam360-glcore']._picam360map2scene_init(m_canvas.width, m_canvas.height);
							m_modules['picam360-glcore']._picam360map2scene_set_target_fps(60/(1 + m_skip_frame));
							//m_modules['picam360-glcore']._picam360map2scene_set_mode(m_p2s_mode);
							if(callback){
								callback();
							}
						},
				...
				script.src = m_base_path + 'picam360-glcore.js';
